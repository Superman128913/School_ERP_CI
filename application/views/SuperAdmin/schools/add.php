			...
			<div class="main">
                ...
                <?php echo form_open_multipart('schools/add');?>

					<!-- breadcrumb -->
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Schools</h4>
                                    <span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Register
                                </span> 
							</div>
						</div>
						<div class="d-flex my-xl-auto right-content">
                            
                             <button name="add" type="submit" class="btn ripple btn-primary"><i class="fas fa-download"></i> &nbsp;  Save  </button>
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-body">
                                        ...
                                        <div class="col-sm-12 col-md-4 mg-t-2 mg-sm-t-0" style="border-right:1px solid lightgray;">
                                            
                                           <h6 class="card-title mb-1">Schools Detail</h6>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 form-group">
                                                    ...
                                                    <input required name="sch_name" type="text" class="form-control">
                                                </div>
                                                

                                                <div class="col-sm-12 form-group">
                                                    <label for="">School City</label>
                                                    <input required name="sch_city" type="text" class="form-control">
                                                </div>
                                            ...
                                            <div class="col-sm-12 col-md-7 mg-t-9 mg-sm-t-0">
                                                ...
                                                <h6 class="card-title mb-1">Admin Detail</h6>
                                                <p class="text-muted card-sub-title"></p>
